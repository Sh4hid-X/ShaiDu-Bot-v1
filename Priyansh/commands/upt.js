...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝙇𝙀𝙂𝙀𝙉𝘿 𝘽𝙊𝙏", canvas.width / 2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("𝙎𝙝𝙖𝙞𝘿𝙪 𝙋𝙧𝙤𝙅𝙚𝙘𝙏", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝐓𝐡'𝐰 𝐒𝐡𝐚𝐢𝐃𝐮", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝐒𝐇4𝐇𝐈𝐃-𝐗", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("𝐏𝐮𝐧𝐣𝐚𝐛𝐢_𝐱_𝐌𝐮𝐧𝐝𝐚", 2000, 3600);
    ctx.beginPath();
